        ...
        <div class="card-body">
            <div class="card-body">
                <h2 class="w3-text-black">To-Do List
                    ...
                    <div class="modal fade" id="addModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <div style="width: 100%; border-radius: 10px 10px 10px 10px;">
                                        <div class="card-body">
                                            <div class="card-body">
                                                ...
                                                <form action="<?= base_url('index.php/welcome/add_task'); ?>" method="post">

                                                    <input type="hidden" value=<?= $student_number ?> name="student_number" id="student_number">
                                                    <div>
                                                        <h5>Task</h5>
                                                    </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="<?= base_url('index.php/welcome/todo_update/' . $list['id']); ?>" method="post">
                                                    <input type="hidden" value=<?= $student_number ?> name="student_number" id="student_number">
